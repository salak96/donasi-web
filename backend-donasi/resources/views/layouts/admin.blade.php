...
<html lang="en">
  <head>
    ...
    <title>Admin DONASI| @yield('title')</title>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-5">
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('kategoris') }}" class="nav-link {{ (request()->is('kategoris*')) ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{ url('donaturs') }}" class="nav-link {{ (request()->is('donaturs')) ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{ url('profils') }}" class="nav-link {{ (request()->is('profils*')) ? 'active' : '' }}">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 1996-2022 <a href="https://adminlte.io">lambang_art</a>.</strong>
      All rights reserved.
